...
class Admin {
  ...
  async create(event) {
    ...
    tenant.companyName = tenant.companyName
      ? tenant.companyName
      : tenant.accountName;
    tenant.accountName = tenant.accountName
      ? tenant.accountName
      : tenant.companyName;
    ...
    return new Promise(function (resolve, reject) {
      ...
      tenantExists(tenant)
        ...
        .catch((err) => {
          console.log(
            "no tenant try Creating system admin user, tenant userName: " +
              tenant.userName
          );
          registerTenantAdmin(tenant)
            ...
            .catch(function (error) {
              console.log(
                "Error registering new system admin user: " + error.message
              );
...
function registerTenantAdmin(tenant) {
  ...
  var promise = new Promise(function (resolve, reject) {
    ...
    // functionName = 'EnvyForgeIdentity-UserMgr-dev-createSystem';
    var functionName = serviceDiscovery.getServiceName(
      process.env.PROJECT_NAME,
      "UserMgr",
      "createSystem",
